  ...
  return (
    <>
      <div className="legalbar">
        <div className="legalbar__lines">
          <span className="legalbar__l">お酒は20歳になってから。</span>
          <span className="legalbar__sep">｜</span>
          <span className="legalbar__l"><b>20歳未満の飲酒・購入は法律で禁止されています。</b></span>
          <span className="legalbar__sep">｜</span>
          <span className="legalbar__l">本サイトは「日本酒屋」が運営する広告（PR）です。</span>
        </div>
        <span className="legalbar__age">20歳未満の飲酒・購入はできません</span>
      </div>
