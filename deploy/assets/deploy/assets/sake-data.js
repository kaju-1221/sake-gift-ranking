...
window.SAKE_DATA = [
  ...
  },
  {
    ...
    price: "¥3,000",
    priceTbd: false,
    review: "学習院大学理学部で酵母を研究する尾仲宏康教授が、自然発酵ワインで知られる栃木のココ・ファーム・ワイナリーで採取したオリジナルの野生ワイン酵母で醸した日本酒です。2025年末のクラウドファンディングMakuakeでは達成率222％で終了した大人気酒。ワインよりフレッシュなぶどうに近い酸味と野生酵母ならではのしっかりした味わいとキレの良さで食中酒として最適。一般販売はほぼ日本酒屋のみという入手困難な限定酒を、プレゼントにぜひ。",
  ...
  },
  {
    ...
    food: "ジビエ / 中華 / ビターチョコ",
    scene: "日本酒通な方へ",
    forWhom: "地元でも希少。熟成酒好きな方、日本酒通な方へのプレゼントに",
    price: "¥5,000",
    priceTbd: false,
    review: "30年間常温で熟成させた古酒で、地元でもほとんど流通していない希少酒。熟成酒好きな方、日本酒通な方へのプレゼントにおすすめです。ジビエや中華、エスニックなど、しっかりした味の料理に好相性。ブランデーのようなすっきりとした苦味の後口で、ビターチョコレートとの相性も抜群です。",
  ...
  },
  {
    ...
    price: "¥10,000",
    priceTbd: false,
    review: "山田錦を雫取りで搾った、雑味のない端正な味わい。気品ある吟醸香と絹のような口当たりは、まさに“秘蔵”の名にふさわしい。日本酒に親しんだ方にも自信を持って贈れる最高ランクの正統派です。",
  ...
  },
  {
    ...
    price: "¥3,000",
    priceTbd: false,
    review: "樽由来のバニラやハチミツ、カラメルを思わせる甘いフレーバーに、微かなスモーキーさと水酛特有の乳酸系の香りが複雑に重なります。水酛由来の厚みのある甘旨味と、樽から抽出された芳醇な熟味が調和し、余韻は日本酒というよりもウイスキーを彷彿とさせる独特な深みへと続きます。冷酒から常温、ぬる燩まで幅広くお楽しみいただけます。また、ロック、ソーダ割り、お湯割りでは樽香と水酛の個性が華やかに開きます。煮魚、チーズ、ビターチョコとも相性抜群です。日本酒もウイスキーも好き、という方への贈り物としてぴったりです。",
    axes: { sweet: 40, body: 78, mature: 70 },
    url: "https://nihonshuya.stores.jp/items/69ec54cc73db3d5a9421b49f"
  },
  {
    rank: 6,
    name: "narai sankei Type d 熟成 23.01",
  ...
  },
  {
    ...
    food: "すき焼き / うなぎの蒲焼 / 黒酢酢豚 / ブルーチーズ",
    scene: "甘口好きの方へ",
    forWhom: "甘口やフルーティが好きな方、スイーツと楽しみたい方へ",
    price: "¥2,200",
    priceTbd: false,
    review: "日本酒度なんと−55（甘辛の指標で、一般に−10以下で超甘口と言われます）。日本酒なのに梅酒のような酸味と甘味、それでいて後口のキレが良いという謎スペック。スイーツやフルーツと合わせても相性が良く、すき焼きなど牛肉との相性も抜群です。",
    axes: { sweet: 0, body: 100, mature: 40 },
    url: "https://nihonshuya.stores.jp/items/64ce07256c50d711d8a24feb"
  },
  {
    rank: 8,
    name: "豊能梅 純米吟醸 いとをかし 生酒",
    ...
    food: "ホタテのカルパッチョ / 生牡蠣 / 生春巻き / カマンベールチーズ",
    scene: "日本酒入門・女性へ",
  ...
  },
  {
    ...
    rarity: 4,
    taste: "すっきり・やさしい・キレ",
    food: "真鯛の昆布締め / ホタルイカの沖漬け / 鮎の塩焼き / 山菜や魚介の天ぷら",
    scene: "普段の贈り物に",
  ...
  },
  {
    ...
    food: "ホタテのバター醤油焼き / 鮎の塩焼き / 鶏肉のハーブ焼き / カツオのたたき / 銀だらの西京焼き",
    scene: "間違いない定番に",
    forWhom: "外したくない、安心の定番を贈りたい方へ",
    price: "¥2,000",
    priceTbd: false,
    review: "北海道産酒米「吟風」を100％使った限定商品。北海道限定販売。やわらかな吟醸香と、ミントのようなすっきりした爽やかさ、ほろ苦さが口に広がります。「何を贈るか迷ったら、まずこれ」と言える定番の一本です。",
